 ...
 * Headings: the class has a rule for what to omit, a rule for how to handle heading 1, a rule for handling 
 * heading 2
 * Style: the class has a rule for bold and a rule for italics.
 * 
 * All these rules dictate when something is to be treated as h1, or bold, etc.
 ...
 * 
 * The class comes with two methods, that, given a LineBlock, decide which classification applies (a) for its
 * heading and (b) for its style
 * 
 * @author pvassil
 * @version 0.1
 */
public class RuleSet {
	...
	public FormatEnum determineFormatStatus(LineBlock lineblock) {
		if (lineblock.getStyle()!= StyleEnum.NORMAL)		// if OMITTED, H1, H2 -> format=REGULAR
