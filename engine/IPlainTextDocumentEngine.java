...
public interface IPlainTextDocumentEngine {
	 ...
	 * 
	 * Returns a RuleSet object as the result of the parsing and internal representation of the rules 
	 ...
	 * Every category absent is setup to undefined status and eventually mapped to the resp. RuleUndefined 
	 * object that always returns false for isValid()
	 * The 0th element is the aforementioned category representative string
	 * The 1st element is STARTS_WITH, POSITIONS, ALL_CAPS 
	 * The 3rd element is a prefix string for STARTS_WITH or a comma-separated string of positions 
	 * (starting from 0) for POSITIONS
	 * 
	 * @param inputSpec a List of (List of String) with the specification of the rules on how to handle 
	 * paragraphs
	 * @return a RuleSet object as the result of the parsing and internal representation of the rules 
	 * expressed as strings.
	 */
	 ...
	 * (starting from 0) for POSITIONS
	 * 
	 * The prefixes parameter represents the List<String> to report on the marks at the beginning of each 
	 * paragraph.
	 * 
	 *  
	 * @param inputSpec a List of (List of String) with the specification of the rules on how to handle 
	...
	/**
	 * Takes the input file specified at the constructor, loads it and processes it according to the rule set
	 ...
	 * 
	 *  If the input files has not been processed, and the this.lineblocks attribute has a size of 0, the 
	 *  method loads and characterizes the input
	 *  	
